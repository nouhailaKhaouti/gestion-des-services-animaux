      ...
      <section class="py-xxl-10 pb-0" id="home">
        ...
        <div class="container">
          <div class="row min-vh-xl-100 min-vh-xxl-25">
            <div class="col-md-5 col-xl-6 col-xxl-7 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="assets/img/gallery/adopt.jpg" alt="hero-header" width="600" height="600" style=" border-radius: 8px; " /></div>
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-6">
              <h1 class="fw-light font-base fs-6 fs-xxl-7"><strong>Adoption Posts </strong></h1>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="card h-100 shadow card-span rounded-3">
                         ...
                         <div class="d-flex align-items-center justify-content-between">
                                ...
                                <img  style="margin-bottom:10px;" class="h-10 w-10 rounded-full object-cover" src="profileimage/{{$post->user->image}}" href="">
                                    <div class="ml-2">
                                    <p> <strong><a href="{{url('user_profile',$post->user->id)}}"> {{$post->user->username}}</a> </strong> <br> </p>
                                    </div>
                                    <div class="ml-2">
                                    <p>  {{$post->created_at}}</p>
                                    </div>
